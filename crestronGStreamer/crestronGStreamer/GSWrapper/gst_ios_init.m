...
// TjB: This is a temporary solution to deal with ambiguous defs of TRUE & FALSE that
//      causes warnings in files in the version of the GStreamer framework that I am
//      using. I would plan to investigate a better fix, or suggest changes to the
//      GStreamer maintainers. This is not a good idea as some code somewhere could
//      rely on a different define value for these.
#define TRUE    1
#define FALSE   0
#include <gio/gio.h>
